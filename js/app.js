(function($, document, window){
	...
	$(document).ready(function(){
		...
		var eventCarousel2 = $(".event-carousel2");
		eventCarousel2.owlCarousel({
		...
		$("#event-next2").click(function(e){
			e.preventDefault();
			eventCarousel2.trigger('owl.next');
		});
		$("#event-prev2").click(function(e){
			e.preventDefault();
			eventCarousel2.trigger('owl.prev');
		});
